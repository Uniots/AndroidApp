package com.example.androidapp.librarytrezvucha
 ...
 * kjhgf
 *
 * This composable was generated from the UI Package 'library_trezvucha'.
 * Generated code; do not edit directly
 */
@Composable
fun LibraryTrezvucha(
    modifier: Modifier = Modifier,
    onButtonendTapped: () -> Unit = {}
) {
    TopLevel(modifier = modifier) {
        TrezvHead()
        ButtonEnd(
            onButtonendTapped = onButtonendTapped,
...
@Composable
private fun LibraryTrezvuchaPreview() {
    MaterialTheme {
        RelayContainer {
            LibraryTrezvucha(
                onButtonendTapped = {},
...
@Composable
fun TrezvHead(modifier: Modifier = Modifier) {
    RelayText(
        content = "Трезвучия",
        fontSize = 32.0.sp,
...
fun Ellipse1(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.library_trezvucha_ellipse_1),
...
fun Line3(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.library_trezvucha_line_3),
...
fun Line4(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.library_trezvucha_line_4),
        modifier = modifier.requiredWidth(24.83948516845703.dp).requiredHeight(0.0.dp)
    )
}
...
fun ButtonEnd(
    ...
    RelayContainer(
        ...
        clipToParent = false,
        content = content,
        modifier = modifier.tappable(onTap = onButtonendTapped).requiredWidth(53.0.dp).requiredHeight(53.0.dp)
    )
}

@Composable
fun TextTrezv(modifier: Modifier = Modifier) {
    RelayText(
...
fun Ellipse2(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.library_trezvucha_ellipse_2),
...
fun Pngwing3(modifier: Modifier = Modifier) {
    RelayImage(
        image = painterResource(R.drawable.library_trezvucha_pngwing_3),
...
fun Image1(modifier: Modifier = Modifier) {
    RelayImage(
        image = painterResource(R.drawable.library_trezvucha_image_1),
        contentScale = ContentScale.Crop,
